        ...
        <div className="bg-white px-4 sm:px-6 py-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 mb-6">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-neutral-600 mb-1">
                <span className="font-medium">From:</span> Grihinee - 10 Minute App
              </div>
              <div className="text-sm text-neutral-600 space-y-1">
                ...
                <div>
                  <span className="font-medium">Email:</span> info@grihinee.com
                </div>
                <div>
          ...
          <div className="border-t border-dashed border-neutral-300 pt-4">
            <p className="text-sm text-neutral-600 text-center">
              Bill Generated by Grihinee - 10 Minute App
            </p>
          </div>
        </div>
      </div>
