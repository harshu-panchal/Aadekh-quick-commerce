...
export default function SellerHeader({
  ...
  return (
    <header className="bg-white shadow-sm border-b border-neutral-200 sticky top-0 z-30">
      <div className="flex items-center justify-between px-3 sm:px-4 md:px-6 py-2 sm:py-4 h-14 sm:h-auto">
        {/* Logo and Hamburger Menu */}
        <div className="flex items-center gap-0 w-full sm:w-auto">
          {/* Hamburger Menu Button - Hidden on mobile, use bottom nav instead */}
          <button
            onClick={onMenuClick}
            className="p-2 text-neutral-600 hover:text-neutral-900 transition-colors flex-shrink-0 md:flex items-center hidden"
          ...
          <button
            ...
            className="hover:opacity-80 transition-opacity -ml-2 flex items-center">
            <img
              src="/assets/grihinee-logo.png"
              alt="Grihinee"
              className="h-16 sm:h-28 w-auto object-contain cursor-pointer -my-2 sm:-my-8 relative z-50 ml-0"
              style={{ maxWidth: "none" }}
            />
          </button>

          {/* Action Icons for Mobile (Settings/Location in a compact way if needed) */}
