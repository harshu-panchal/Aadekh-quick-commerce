      ...
      <div className="w-full max-w-sm relative z-10 backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] overflow-hidden animate-fade-in-up">
        <div className="p-6 relative">
          ...
          {!showOTP ? (
                  ...
                  <div className="p-2 bg-red-500/20 border border-red-500/30 backdrop-blur-sm text-red-100 text-xs rounded-lg flex items-center gap-2 animate-shake">
                    ...
                    {isNotRegistered && (
                      <button
                        ...
                        className="text-[10px] font-bold text-white bg-red-500 hover:bg-red-600 px-2 py-1 rounded transition-colors ml-auto">
                        Register Now
                      </button>
                    )}
                  </div>
            ...
            <div className="space-y-5 animate-fade-in">
              ...
              {error && (
                <div className="p-2 bg-red-500/20 border border-red-500/30 backdrop-blur-sm text-red-100 text-xs rounded-lg text-center animate-shake">
                  {error}
                </div>
              )}
        ...
        <div className="px-6 py-3 bg-black/20 border-t border-white/10 text-center backdrop-blur-md">
          <p className="text-[9px] text-white/50 leading-relaxed uppercase tracking-wider">
            By continuing, you agree to Grihinee's Terms of Service and Privacy Policy
          </p>
        </div>
      </div>
    </div>
